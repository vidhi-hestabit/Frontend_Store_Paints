            ...
            <div className="paint-form-card" style={{ width: '100%' }}>
                ...
                <form onSubmit={submitHandler}>
                    <div className="paint-form-group">
                        ...
                        <input name="email" value={formData.email} onChange={onChangerHandler} type="email" className="paint-form-input" placeholder="you@example.com" />
                    </div>
                    <div className="paint-form-group">
                        <label className="paint-form-label">Password</label>
                        <input name="password" value={formData.password} onChange={onChangerHandler} type="password" className="paint-form-input" placeholder="••••••••" />
                    </div>
